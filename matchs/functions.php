<?php
    ...
    /**
 * Met à jour les scores (5 sets) dans la table Rencontre
 * et met à jour les notes associées aux joueurs (via leurs rôles) dans la table Participer.
 *
 * @param PDO   $linkpdo Instance PDO pour la connexion à la base
 * @param array $data    Données reçues (scores, notes, etc.)
 *
 * @return bool          Retourne true en cas de succès
 * @throws Exception     Jette une exception en cas d'erreur
 */
